...
void ofApp::setup(){
    ...
    f = FireFliesTest();
    //numFireFliesTest = 10;
    numFireFliesTest = 100;
    
    for(int i = 0; i <numFireFliesTest; i++){
        FireFliesTest tempP = FireFliesTest();
        firefliestest.push_back(tempP);
    }
...
void ofApp::update(){
    ...
    for(int i = 0; i < contourFinder.nBlobs; i++){
        ...
        for(int i = 0; i <firefliestest.size(); i++) {
            firefliestest[i].seek();
            firefliestest[i].update();
        }
...
void ofApp::mousePressed(int x, int y, int button){
    ...
    for(int i = 0; i < firefliestest.size(); i++) {
        firefliestest[i].moveTarget(loc);
    }
