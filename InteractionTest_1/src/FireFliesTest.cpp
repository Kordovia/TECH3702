...
#include "FireFliesTest.h"

FireFliesTest::FireFliesTest(){
...
void FireFliesTest::applyForce(ofPoint f){
...
void FireFliesTest::moveTarget(ofPoint inTarget){
