...
#include "FireFliesTest3.h"


FireFliesTest3::FireFliesTest3(){
...
void FireFliesTest3::applyForce(ofPoint f){
...
void FireFliesTest3::moveTarget(ofPoint inTarget){
